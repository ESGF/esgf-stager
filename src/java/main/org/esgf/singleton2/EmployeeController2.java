...
public class EmployeeController2 {
	...
	private static final String XML_VIEW_NAME = "employee";
	/*
	...
	*/
	/*
	@RequestMapping(method=RequestMethod.POST, value="/function")
	public void postSomething(@RequestBody String body) {
	...
	*/
	...
	public ModelAndView getEmployee() {
		...
		return new ModelAndView(XML_VIEW_NAME, "employee", list);
